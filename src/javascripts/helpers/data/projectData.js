const projects = [
  {
    title: 'Narnia ChatLog',
    screenshot: 'http://via.placeholder.com/100',
    description: 'A simple chatlog for the Pensieves and Aslan', // A good project description includes 'the what', 'the why', and 'the how'.
    technologiesUsed: 'HTML, CSS, Vanilla JavaScript, Version Control with Github',
    available: true,
    url: 'https://github.com/gwynnemeeks/chatty-delta-narnia', // Github links
    githubUrl: 'https://github.com/gwynnemeeks/chatty-delta-narnia',
  },
  {
    title: 'Gwynterist',
    screenshot: 'http://via.placeholder.com/100',
    description: 'An attempt to make a simplified Pinterest', // A good project description includes 'the what', 'the why', and 'the how'.
    technologiesUsed: 'HTML, CSS, Vanilla JavaScript, Version Control with Github',
    available: true,
